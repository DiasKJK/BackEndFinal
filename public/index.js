...
const addCarousel = () => {
  ...
  <div class="image-container">
    <img src='${selectedImage}' alt='carousel image' style='max-width: 100%; max-height: 100%;'>
  </div>
  <img class="delete__icon" src="./assets/delete.svg" alt="delete" onclick="removeSlideHandler(this)"/>
